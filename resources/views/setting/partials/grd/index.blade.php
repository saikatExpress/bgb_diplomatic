    ...
    <div class="container mt-4">
        <div class="card shadow-lg border-0">
            <div class="card-header text-white d-flex justify-content-between align-items-center"
                ...
                <h5 class="mb-0">🏭 All GRD</h5>
                <a href="{{ route('grd.create') }}" class="btn btn-light btn-sm">
                    <i class="fa fa-plus"></i> Add GRD
                </a>
            </div>
            <div class="card-body">
                ...
                <!-- Filter Form -->
                @include('setting.partials.grd.components.filter-form')

                <!-- DataTable -->
                <div class="table-responsive">
                    <table id="grdTable" class="table table-bordered table-striped align-middle">
