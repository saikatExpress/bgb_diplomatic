...
@section('content')
    <div class="form-container">
        ...
        <div class="form-header">Create New GR</div>

        <form id="createGrForm">
            @csrf
            <!-- Name -->
            <div class="mb-3">
            ...
            <!-- Submit -->
            <div class="d-grid">
                <button type="submit" class="btn btn-sm btn-submit">Create GR</button>
            </div>
        </form>
    </div>
@endsection
        ...
        $(document).ready(function () {
            $('#createGrForm').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    complete: function () {
                        $('.btn-submit').prop('disabled', false).text('Create GR');
                    }
                });
            });
        });
